"""
Django settings for project_reggy project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-2%)o=jzz5-*^@-*c9d*1pr#+g_m-bxcgo#z!9wmp+4vo=kl4r#')
...
ROOT_URLCONF = 'project_reggy.urls'
...
WSGI_APPLICATION = 'project_reggy.wsgi.application'
